...
pub fn help(io: general_enums.Io) void {
    io.stdout.print("Usage: zemit [global options] <command> [command options]\n\n", .{}) catch {};
    io.stdout.print("Available commands\n", .{}) catch {};
    io.stdout.print("    release:              Compiles multi-target and places correctly named binaries.\n", .{}) catch {};
    io.stdout.print("    clean:                Clears the output directory of multi-targets.\n", .{}) catch {};
    io.stdout.print("    init:                 Generates the zemit.toml configuration file.\n", .{}) catch {};
    io.stdout.print("    test:                 Validates your zemit.toml configuration file.\n\n", .{}) catch {};
